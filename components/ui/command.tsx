...
function CommandItem({
  ...
  return (
    ...
    >
      {children}
      <SealCheckIcon className="ml-auto opacity-0 group-has-data-[slot=command-shortcut]/command-item:hidden group-data-[checked=true]/command-item:opacity-100" />
    </CommandPrimitive.Item>
  )
}
...
function CommandShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ml-auto text-[0.625rem] st text-muted-foreground group-data-selected/command-item:text-foreground",
        className
      )}
      {...props}
    />
